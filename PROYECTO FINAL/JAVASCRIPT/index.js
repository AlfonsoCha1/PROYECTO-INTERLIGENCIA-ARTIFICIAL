...
function navegar(idDestino) {
    ...
    if (destino) {
        ...
        console.warn(`No se encontró la sección con ID: ${idDestino}`);
    }
}


// Mapea lo que envían los botones del header -> ID de la sección
...
// Botones de categorías (tu HTML manda 'Entrada' con singular, lo normalizo a 'Entradas')
function mostrarCategoria(nombre) {
  ...
  if (!id) return console.warn('Categoría desconocida:', nombre);
